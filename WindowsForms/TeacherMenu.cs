...
namespace WindowsForms
{
    public partial class TeacherMenu : Form
    {
        ...
        // Nota: ahora async para obtener el usuario actual antes de abrir NotasList
        private async void notasButton_Click(object sender, EventArgs e)
        {
            ...
            {
                // no bloquear la UI si hay problema leyendo sesión; NotasList hará fallback
            }
